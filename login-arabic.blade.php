...
<body class="login-cover">
    ...
    <nav>
        ...
        <div class="left d-flex align-items-center">
            <div class="link">
                <a href="./login.blade.php">English</a>
            </div>
                    ...
                    <section class="form-section">
                        ...
                        <form action="{{route('admin/login')}}" method="POST" role="form" class="form-validate">
                            ...
                            <div class="input-box-main">
                                <div class="label">بريد إلكتروني <span class="red">*</span></div>
                                <div class="input-box">
                            ...
                            <div class="input-box-main mt-4">
                                <div class="label">كلمة المرور <span class="red">*</span></div>
                                <div class="input-box">
                        ...
                        <p class="last-text">هل تواجه مشكلة؟ <a href="#" class="blue">الدعم الفني</a></p>
